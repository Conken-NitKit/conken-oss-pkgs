...
```sh
npm run new:fc -w frontend-react-emotion
```

```sh
$ npm run new:fc -w frontend-react-emotion

> frontend-react-emotion@0.0.0 new:fc
> hygen new fc
...
```sh
npm run storybook -w frontend-react-emotion
```
...
npm run test -w frontend-react-emotion
```
...
```sh
npm i sample-library -w frontend-react-emotion
```
